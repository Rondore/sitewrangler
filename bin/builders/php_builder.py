...
from libsw import build_index, curl, openssl, php, postgresql, image_magic, pecl_imagick, pecl_memcached, pecl_redis
...
index.register_builder( image_magic.ImageMagickBuilder() )
